...
# width: every page divided in 12 columns (width= sets how many columns for the component)
# offset: invisible columns left of the component
# order (1-12):

app.layout = html.Div([
    dbc.Row([
        dbc.Col(html.H3('Hello, this is H3!'),
                    width={'size': 4, 'offset': 1, 'order': 2}),
            dbc.Col(dbc.Button('Success', color='success', className='mr-1'),
